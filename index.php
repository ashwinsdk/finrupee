                ...
                <div class="row gx-5 justify-content-center">
                    <div class="col-lg-6">
                        <div class="text-center my-5">
                            <h1 class="display-5 fw-bolder text-white mb-2">FinRupee


</h1>
                            <p class="lead text-white-50 mb-4">FinRupee


 is an inclusive, integrated and convenient public grievance redressal platform</p>
        ...
        <section class="py-5 border-bottom">
            <div class="container px-5 my-5 px-5">
                <div class="text-center mb-5">
                    <h2 class="fw-bolder">WHAT IS FinRupee
